    ...
    <section ref={sectionRef} id="hero" className="relative min-h-screen flex items-center pl-6 md:pl-28 pr-6 md:pr-12">
      ...
      <div ref={contentRef} className="relative z-10 flex-1 w-full">
        ...
        <div className="mt-16 flex items-center gap-8">
          ...
          >
            <ScrambleTextOnHover text={t.hero.seeProjects} as="span" duration={0.6} />
        ...
        <div className="mt-8 flex items-center gap-6">
          ...
          >
            ...
            <span className="pointer-events-none absolute -bottom-9 left-1/2 -translate-x-1/2 whitespace-nowrap border border-accent bg-background px-2 py-1 font-mono text-[10px] uppercase tracking-widest text-accent opacity-0 group-hover:opacity-100 transition-opacity duration-200">
              {t.hero.tooltips.github}
            </span>
          </a>
